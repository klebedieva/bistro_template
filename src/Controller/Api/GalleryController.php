                    ...
                    properties: [
                        ...
                        new OA\Property(property: 'data', type: 'array', items: new OA\Items(
                            ...
                            properties: [
                                ...
                                new OA\Property(property: 'imageUrl', type: 'string', example: '/uploads/terrasse_2.jpg'),
        ...
        try {
            ...
            $data = array_map(function (GalleryImage $image) use ($req) {
                return [
                    ...
                    'imageUrl' => $req->getSchemeAndHttpHost() . '/uploads/' . $image->getImagePath(),
    ...
    public function show(Request $request, int $id): JsonResponse
    {
        try {
            ...
            $data = [
                ...
                'title' => $image->getTitle(),
                'description' => $image->getDescription(),
                'imageUrl' => $request->getSchemeAndHttpHost() . '/uploads/' . $image->getImagePath(),
                'category' => $image->getCategory(),
                'displayOrder' => $image->getDisplayOrder(),
