 ...
 */
final class Version20250904104138 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($isPostgres) {
            ...
            // MySQL syntax
            $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, author_name VARCHAR(100) NOT NULL, email VARCHAR(180) DEFAULT NULL, rating SMALLINT NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', dish_name VARCHAR(120) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
