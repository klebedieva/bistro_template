    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $rows = [
            ...
            [
                ...
                'price' => '14.00',
                'category' => 'entrees',
                'image' => '/static/img/menu/entree_1.png',
            ...
            [
                ...
                'price' => '13.00',
                'category' => 'entrees',
                'image' => '/static/img/menu/entree_2.png',
                'badges' => ['Végétarien', 'Fait maison'],
                'tags' => ['vegetarian'],
            ],
            [
                ...
                'price' => '15.00',
                'category' => 'entrees',
                'image' => '/static/img/menu/entree_3.png',
            ...
            [
                ...
                'price' => '24.00',
                'category' => 'plats',
                'image' => '/static/img/menu/plat_2.png',
            ...
            [
                ...
                'price' => '24.00',
                'category' => 'plats',
                'image' => '/static/img/menu/plat_9.png',
            ...
            [
                ...
                'price' => '28.00',
                'category' => 'plats',
                'image' => '/static/img/menu/plat_7.png',
                'badges' => ['Traditionnel', 'Spécialité'],
                'tags' => [],
            ],
            [
                ...
                'price' => '16.00',
                'category' => 'plats',
                'image' => '/static/img/menu/plat_8.png',
            ...
            [
                ...
                'price' => '20.00',
                'category' => 'plats',
                'image' => '/static/img/menu/plat_3.png',
                'badges' => ['Traditionnel'],
                'tags' => [],
            ],
            [
                ...
                'price' => '26.00',
                'category' => 'plats',
                'image' => '/static/img/menu/plat_5.png',
            ...
            [
                ...
                'price' => '18.00',
                'category' => 'plats',
                'image' => '/static/img/menu/plat_10.png',
            ...
            [
                ...
                'price' => '12.00',
                'category' => 'plats',
                'image' => '/static/img/menu/plat_12.png',
            ...
            [
                ...
                'price' => '8.00',
                'category' => 'desserts',
                'image' => '/static/img/menu/dessert_1.png',
            ...
            [
                ...
                'price' => '9.00',
                'category' => 'desserts',
                'image' => '/static/img/menu/dessert_2.png',
                'badges' => ['Fait maison', 'Saison'],
                'tags' => ['vegetarian'],
            ],
            [
                ...
                'price' => '10.00',
                'category' => 'desserts',
                'image' => '/static/img/menu/dessert_3.png',
        ...
        foreach ($rows as $r) {
            ...
            // Lier badges/tags via références (appliqué aussi aux éléments existants)
            foreach (($r['badges'] ?? []) as $bn) {
                $ref = BadgeFixtures::REFERENCE_PREFIX . $bn;
                try {
                    $entityRef = $this->getReference($ref, Badge::class);
            ...
            foreach (($r['tags'] ?? []) as $tc) {
                ...
                try {
                    $entityRef = $this->getReference($ref, Tag::class);
            ...
            try {
                ...
                foreach (array_unique($maybe) as $code) {
                    ...
                    $a = $this->getReference(AllergenFixtures::REFERENCE_PREFIX . $code, Allergen::class) ?? null;
