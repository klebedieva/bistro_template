...
CREATE TABLE `contact_message` (
  ...
  KEY `idx_contact_msg_replied_by` (`replied_by_id`),
...
CREATE TABLE `gallery_images` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_gallery_images_is_active` (`is_active`),
  KEY `idx_gallery_images_category` (`category`),
...
CREATE TABLE `menu_item_allergen` (
  ...
  KEY `idx_menu_item_allergen_menu_item_id` (`menu_item_id`),
  KEY `idx_menu_item_allergen_allergen_id` (`allergen_id`),
  KEY `idx_mi_allergen_pair` (`menu_item_id`,`allergen_id`),
...
CREATE TABLE `menu_item_badge` (
  ...
  KEY `idx_menu_item_badge_menu_item_id` (`menu_item_id`),
  KEY `idx_menu_item_badge_badge_id` (`badge_id`),
  KEY `idx_mi_badge_pair` (`menu_item_id`,`badge_id`),
...
CREATE TABLE `menu_item_tag` (
  ...
  KEY `idx_menu_item_tag_menu_item_id` (`menu_item_id`),
  KEY `idx_menu_item_tag_tag_id` (`tag_id`),
  KEY `idx_mi_tag_pair` (`menu_item_id`,`tag_id`),
...
CREATE TABLE `order_item` (
  ...
  KEY `idx_order_item_menuitem` (`menu_item_id`),
...
INSERT INTO `order_item` VALUES (6,5,141,'Galinette poêlée à l\'ajo blanco',24.00,3,72.00,NULL),(7,6,147,'Potimarron Rôti aux Saveurs d\'Asie',18.00,1,18.00,NULL),(8,7,138,'Œuf Mollet au Safran et Petits Pois',13.00,1,13.00,NULL),(9,7,137,'Asperges Printemps à la Ricotta',14.00,2,28.00,NULL),(13,11,142,'Sashimi de ventrèche de thon fumé',24.00,1,24.00,NULL),(14,12,147,'Potimarron Rôti aux Saveurs d\'Asie',18.00,1,18.00,NULL),(15,13,150,'Tartelette Ricotta au Miel et Fraises',9.00,1,9.00,NULL),(22,20,145,'Spaghettis à l\'ail noir et parmesan',20.00,1,20.00,NULL),(23,21,143,'Magret de canard au fenouil confit',28.00,3,84.00,NULL),(24,22,137,'Asperges Printemps à la Ricotta',14.00,1,14.00,NULL),(47,42,138,'Œuf Mollet au Safran et Petits Pois',13.00,4,52.00,NULL);
...
CREATE TABLE `reviews` (
  ...
  `menu_item_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_reviews_menu_item` (`menu_item_id`),
...
-- Dump completed on 2025-11-11 10:53:09
